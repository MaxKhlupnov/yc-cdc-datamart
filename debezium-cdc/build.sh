...
# create trusted CA store and add YandexCA.crt as trusted root
#docker build -t debezium/kafka:1.6 -f ./kafka/1.6/Dockerfile kafka/1.6/.
#docker build -t debezium/connect-base:1.6 -f ./connect-base/1.6/Dockerfile connect-base/1.6/.
#docker build -t debezium/connect:1.6 -f ./connect/1.6/Dockerfile connect/1.6/.
#docker build -t yc/connect:1.6 -f ./yc-connect/1.6/Dockerfile yc-connect/1.6/.
...
#docker build -t debezium/kafka:1.4 -f ./kafka/1.4/Dockerfile kafka/1.4/.
#docker build -t debezium/connect-base:1.4 -f ./connect-base/1.4/Dockerfile connect-base/1.4/.
#docker build -t debezium/connect:1.4 -f ./connect/1.4/Dockerfile connect/1.4/.
docker build -t yc/connect:1.4 -f ./yc-connect/1.4/Dockerfile yc-connect/1.4/.